...
def init_trainer_config(configs):
    ...
    trainer_config["callbacks"] = [
        ...
        ModelCheckpoint(
            dirpath=ckpt_dir,
            save_top_k=-1,
            every_n_epochs=configs["trainer"]["save_epoch"],
        ),  # if you have only limited space, just set save_top_k=1 to save the best model
    ]
...
def experiment(variant):
    ...
    _kwargs = {
        ...
        "ckpt_path": variant[
            "resume"
        ],  # when you want to restore your training, modify this variant
    }
